<template>
	<view class="bg-white margin radius">
		<view class="grid col-6 padding zaiui-sell-quickly-box">
			<view class="live-box">
				<view class="text-black text-lg text-bold">借阅列表</view>
				...
				<view class="user-list-box">
					<swiper class="swiper" disable-touch :touchable="false" autoplay circular vertical previous-margin="23.5rpx"
						next-margin="23.5rpx" interval="2000" :current="indexs" @animationfinish="earnSwiper">
