	...
	<view class="zaiui-my-box" :class="show?'show':''">
		...
		<view class="zaiui-view-content">
			...
			<view class="padding-xs bg-white zaiui-user-info-order-box">
				<view class="text-black text-lg text-bold padding-sm">清单</view>
				<view class="cu-list grid col-4 no-border">
					<view class="cu-item" @tap="myBorrowList">
						<view class="text-xxl text-red" v-if="login">
							<text class="cuIcon-presentfill"></text>
						</view>
						<view class="text-xxl text-black" v-else>12</view>
						<text class="text-sm">我借阅的</text>
					</view>
					<view class="cu-item" @tap="myBorrowList">
						<view class="text-xxl text-red" v-if="login">
							<text class="cuIcon-presentfill"></text>
						...
						<text class="text-sm">我的预约课</text>
					</view>
					<view class="cu-item" @tap="myBorrowList">
						<view class="text-xxl text-red" v-if="login">
							<text class="cuIcon-presentfill"></text>
						</view>
						<view class="text-xxl text-black" v-else>6</view>
						<text class="text-sm">我的正式课</text>
					</view>
				</view>
			</view>
			<view class="padding-xs bg-white zaiui-user-info-order-box">
				<view class="text-black text-lg text-bold padding-sm">余额</view>
				<view class="cu-list grid col-4 no-border">
					<view class="cu-item" @tap="myBorrowList">
						<view class="text-xxl text-red" v-if="login">
							<text class="cuIcon-presentfill"></text>
						</view>
						<view class="text-xxl text-black" v-else>888.88</view>
						<text class="text-sm">借阅余额</text>
					</view>
					<view class="cu-item" @tap="myBorrowList">
						<view class="text-xxl text-red" v-if="login">
							<text class="cuIcon-presentfill"></text>
						</view>
						<view class="text-xxl text-black" v-else>10000.00</view>
						<text class="text-sm">课时余额</text>
					</view>
				</view>
			</view>
				...
				<view class="grid col-2 money-col">
					<view class="money-item">
						<view class="money-item-view">
							<view class="cu-avatar lg" style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/my/1.png);" />
					...
					<view class="money-item">
						<view class="money-item-view">
							<view class="cu-avatar lg" style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/my/2.png);" />
							<view class="money-content">
			...
			<view class="padding-xs bg-white margin-top zaiui-user-info-tools-box">
				<view class="padding-sm tools-view">
					<view class="text-black text-bold text-lg tools-title">其他应用</view>
		...
		.zaiui-head-box {
			...
			.zaiui-user-info-box {
				...
				.cu-list.menu-avatar>.cu-item {
					...
					.content {
						width: calc(100% - 94rpx - 59rpx - 20rpx);
			...
			.zaiui-user-info-tip-box {
				position: relative;
				margin: 18.18rpx 27rpx;
				border-radius: 9rpx;
				padding: 18.18rpx 27rpx;
				background: #ea8d8d;
