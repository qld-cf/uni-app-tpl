<template>
	<view class="zaiui-find-box" :class="show?'show':''">
		...
		<view class="zaiui-view-content" v-if="TabCur == 0">
			...
			<trends-list :list_data="followTrendsData" :viewBtn="true" @userTap="trends_userTap" @followTap="trends_followTap"
				@contentTap="trends_contentTap" @imgTap="trends_imgTap" @talkTap="trends_talkTap"
				@viewBtnTap="trends_viewBtnTap" @commentTap="trends_commentTap" @appreciateTap="trends_appreciateTap" />
		...
		<view class="zaiui-view-content" v-if="TabCur == 1">
			...
			<!--动态列表1-->
			<trends-list :list_data="trendsData" :isMax="2" @userTap="trends_userTap" @followTap="trends_followTap"
				@contentTap="trends_contentTap" @imgTap="trends_imgTap" @talkTap="trends_talkTap"
			...
			<!--动态列表2-->
			<!-- <trends-list :list_data="trendsData" :isMin="2" @userTap="trends_userTap" @followTap="trends_followTap"
				@contentTap="trends_contentTap" @imgTap="trends_imgTap" @talkTap="trends_talkTap"
				@forwardTap="trends_forwardTap" @commentTap="trends_commentTap" @appreciateTap="trends_appreciateTap" /> -->
...
<style lang="scss" scoped>
	...
	.zaiui-title-tab-box {
		...
		top: 0;
		z-index: 999999;
		padding: calc(var(--status-bar-height) + 9rpx) 27rpx 9rpx 9rpx;
