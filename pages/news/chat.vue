			...
			<scroll-view scroll-into-view="news15" scroll-y class="scroll-view" @scroll="chatScroll" :scroll-top="scroll_top">
				...
				<view id="news3" class="news-view-item notice">
					<view class="bg-white notice-content-view">
						<view class="cu-avatar round"
							style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/news/abb.png);" />
				...
				<view id="news14" class="news-view-item left">
					...
					<view class="news-content">
						<view class="bg-white text-black content">
							<text>测试</text>
							<image class="emoji" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/emoji_1/1.png"
								mode="widthFix" />
							<text>表情的</text>
						</view>
					</view>
				...
				<view id="news15" class="news-view-item right">
					<view class="news-content">
						<view class="bg-blue content">
							<text class="text-sm text-gray status">已读</text>
							<text>测试</text>
							<image class="emoji" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/emoji/1.png"
								mode="widthFix" />
							<text>表情的</text>
						</view>
					</view>
		...
		<view class="bg-white zaiui-footer-fixed zaiui-foot-padding-bottom">
			...
			<view class="zaiui-tools-view" :class="toolsShow?'show':''">
				<view class="cu-list grid col-4 no-border">
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/news/az2.png"
								mode="widthFix" />
						</view>
						<text>拍照</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/news/ayy.png"
								mode="widthFix" />
						</view>
						<text>相册</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/news/azf.png"
								mode="widthFix" />
						</view>
						<text>语音通话</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/news/aze.png"
								mode="widthFix" />
						</view>
						<text>视频</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/news/az4.png"
								mode="widthFix" />
						</view>
						<text>位置</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/news/az3.png"
								mode="widthFix" />
						</view>
						<text>宝贝</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="https://ss1.ypshengxian.com/feassets/interview/pics/images/news/azg.png"
								mode="widthFix" />
						</view>
						<text>联系卡</text>
					</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				goods_img: 'https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/10.png', scroll_top: 0, tipShow: false, chatShow: false, speedyShow: false,
		...
		methods: {
			getEmojiUrl(index) {
				...
				let num = index + 1;
				let url = "https://ss1.ypshengxian.com/feassets/interview/pics/images/" + this.emojiUrl + "/" + num + ".png";
				return url;
			},
			tipShowTap() {
				if (this.tipShow) {
