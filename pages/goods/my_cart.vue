<template>
	<view>
		...
		<view class="margin-tb agreement-checked-view" style="display: flex;align-items: center">
		...
		<view class="bg-white zaiui-footer-fixed zaiui-foot-padding-bottom">
			<view class="cu-bar padding-lr">
				...
				<view class="btn-view">
					<button class="cu-btn radius bg-red" @tap="tapBtn">确认下单(3)</button>
				</view>
			</view>
		</view>
