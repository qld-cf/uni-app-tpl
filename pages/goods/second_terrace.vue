	...
	<view>
		...
		<view class="bg-white padding zaiui-goods-synopsis-view">
			...
			<view class="margin-tb-lg price-view">
				...
				<view class="cu-tag line-blue sm radius">可借30天</view>
				...
				<view class="flex flex-wrap">
					...
					<view class="basis-8">
						<view class="tag-view-box">
							...
							<text class="text-sm margin-left-xs">本商品赠送借阅专属包装及品胜配件</text>
						</view>
						<view class="tag-view-box">
				...
				<view class="basis-8">
					<view class="tag-view-box">
						<text class="cu-tag bg-white tag-view">
							...
							<text class="margin-left-xs">可借60天</text>
						</text>
						<text class="cu-tag bg-white tag-view">
							<text class="cuIcon-roundcheck text-red" />
							<text class="margin-left-xs">可借30天</text>
						</text>
					</view>
				</view>
				<view class="basis-1">
		...
		<view class="margin-top padding bg-white zaiui-details-view-box">
			<view class="text-xl title-view">
				...
				<text class="text-black">书籍详情</text>
			</view>
			...
			<view class="flex flex-wrap margin-bottom">
				...
				<view class="basis-9">
					...
					<view class="text-sm text-gray">
						借阅自营的每部二手手机皆经过质检工程师51项专业质检并出具了详细的配套验机评估报告，且提供7天试用和180天售后质保服务;成色为[全新]的手机，为官方全新原装手机，与官方门店购买的没有任何差别，享受官方质保与借阅提供的180天售后质保服务，可以放心选购哦
					</view>
				</view>
			</view>
			<view class="flex flex-wrap margin-bottom">
