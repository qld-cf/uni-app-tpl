<template>
	<view>
		...
		<bar-title bgColor='bg-white'>
			<block slot="content">订单二维码</block>
		</bar-title>
		...
		<!-- <view class="margin-tb-sm zaiui-view-box">
			<view class="bg-white zaiui-card goods-view">
				<view class="margin-bottom-sm title-view">
					<view class="cu-avatar sm round" style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/avatar/1.jpg)"/>
		...
		<!-- <view class="margin-tb agreement-checked-view">
			...
			<view class="text-black-view">
				...
				<text class="text-blue">《借阅平台用户服务协议》</text>
			</view>
		</view> -->
...
<script>
	...
	export default {
		...
		data() {
			return {
				goodsList: [], checkAll: true, goods_img: 'https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/1.png',
			}
		},
		onLoad() {
