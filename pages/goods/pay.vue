		...
		<view class="bg-white zaiui-pay-view">
			<radio-group class="block" @change="RadioChange">
				<view class="zaiui-pay-bar" @tap="payTap('wechat')">
					...
					<view class="action">
						<radio class="red zaiui-radio" :class="radio=='wechat'?'checked':''" :checked="radio=='wechat'?true:false"
							value="wechat" />
					</view>
				</view>
				...
				<view class="zaiui-pay-bar" @tap="payTap('alipay')">
					...
					<view class="action">
						<radio class="red zaiui-radio" :class="radio=='alipay'?'checked':''" :checked="radio=='alipay'?true:false"
							value="alipay" />
					</view>
				</view>
			</radio-group>
...
<script>
	...
	export default {
		...
		data() {
			return {
				goodsList: [], checkAll: true, goods_img: 'https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/1.png', radio: 'wechat',
			}
		},
		onLoad() {
