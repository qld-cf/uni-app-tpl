<template>
	<view>
		...
		<bar-title bgColor='bg-white'>
			<block slot="content" v-if="barShow">书籍详情</block>
		...
		<view class="bg-white padding zaiui-goods-synopsis-view">
			<view class="user-view">
				...
				<text class="text-gray text-sm text-right-view">书质保证</text>
			</view>
		...
		<view class="margin-top padding bg-white zaiui-details-view-box">
			<view class="text-black text-xl title-view">书籍详情</view>
			...
			<view class="zaiui-img-box">
				<image src="https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/11.png" mode="widthFix" />
				<image src="https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/12.png" mode="widthFix" />
			</view>
			...
			<view class="cu-list menu-avatar ">
				<view class="cu-item">
					...
					<view class="content">
						...
						<view class="flex">
							<text class="text-sm text-gray">90后 白羊座 女生 书质保证</text>
						</view>
					</view>
					<view class="action">
		...
		<view class="margin-top padding bg-white zaiui-interaction-view-box">
			...
			<view class="zaiui-interaction-view" v-else>
				...
				<view class="zaiui-interaction-list-view">
					<view class="list-itme">
						<view class="cu-avatar round"
							style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/avatar/2.jpg);" />
						<view class="view-box">
					...
					<view class="list-itme">
						<view class="cu-avatar round"
							style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/avatar/3.jpg);" />
						<view class="view-box">
							<view class="title-box">
					...
					<view class="list-itme">
						<view class="cu-avatar round"
							style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/avatar/4.jpg);" />
						<view class="view-box">
							<view class="title-box">
			...
			<view class="zaiui-tag-text-view-box">
				...
				<view class="text-cut">
					<text class="cu-tag line-red radius sm">问</text>
					<text class="text-black margin-lr-xs">走平台，支持借阅验机吗？</text>
					<text class="text-gray text-sm">答：可以小刀</text>
				</view>
			</view>
			<view class="zaiui-border-view" />
		...
		<view class="margin-top padding bg-white zaiui-recommend-goods-box">
			<view class="text-black">为您推荐同型号已检验商品</view>
		...
		<view class="margin-tb zaiui-resemble-goods-box">
			...
			<view class="grid col-2">
					...
					<view class="bg-white item-view">
						...
						<view class="padding-sm zaiui-text-view">
							...
							<view class="text-price-view">
								...
								<text class="cu-tag light bg-red sm radius">已检验</text>
							</view>
							<view class="gps-right-view">
								<text class="text-sm text-gray">重庆 渝北区</text>
								<text class="text-sm text-gray text-right">书质保证</text>
							</view>
						</view>
					</view>
				</view>
				<view class="grid-item-box">
					<view class="bg-white item-view">
						<view class="cu-avatar radius lg"
							style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/4.png);" />
						<view class="padding-sm zaiui-text-view">
							<view class="text-cut text-black text-sm">99新 苹果 iPhoneX 256G 银色</view>
							<view class="text-sm text-gray text-cut tag-view-box">
								<text>银色</text> <text>256G</text>
							...
							<view class="text-price-view">
								<text class="text-price text-lg text-red">2280</text>
								<text class="cu-tag line-blue sm radius">质量保证</text>
							</view>
							<view class="gps-right-view">
								<text class="text-sm text-gray">正品保障 可借30天</text>
							</view>
						</view>
					</view>
				</view>
				<view class="grid-item-box">
					<view class="bg-white item-view">
						<view class="cu-avatar radius lg"
							style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/11.png);" />
						<view class="padding-sm zaiui-text-view">
							<view class="text-cut text-black text-sm">99新 苹果 iPhoneX 256G 银色</view>
							<view class="text-sm text-gray text-cut tag-view-box">
								<text>银色</text> <text>256G</text>
				...
				<view class="grid-item-box">
					<view class="bg-white item-view">
						<view class="cu-avatar radius lg"
							style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/10.png);" />
						<view class="padding-sm zaiui-text-view">
							<view class="text-cut text-black text-sm">99新 苹果 iPhoneX 256G 银色</view>
							<view class="text-sm text-gray text-cut tag-view-box">
								<text>银色</text> <text>256G</text>
