	...
	<view>
		...
		<view class="bg-white padding solid-top" v-if="basics != 4">
			...
			<view class="text-sm text-center margin-top" v-if="basics == 3">
				<view class="text-black">已检验，快递正在路上，务必在收到商品后再确认收货。</view>
				<view class="text-black">
			...
			<view class="zaiui-card-view zaiui-shop-view">
				...
				<view class="goods-list-view">
					...
					<view class="goods-info-view">
						...
						<view class="text-cut tag-view">
							<text class="cu-tag sm line-blue radius">质量保证</text>
				...
				<view class="zaiui-foot-view">
					<view class="left-view">
						...
						<text class="text-black">质量保证</text>
					</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				basics: 0, bg_img: 'https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/1.png', avatar: 'https://ss1.ypshengxian.com/feassets/interview/pics/images/avatar/1.jpg', cancel: false,
				basicsList: [
					{ cuIcon: 'cartfill', name: '未拍下', name_s: '已拍下' }, { cuIcon: 'card', name: '待付款', name_s: '已拍下' },
					{ cuIcon: 'deliver_fill', name: '待发货', name_s: '已发货' }, { cuIcon: 'formfill', name: '待验机', name_s: '已检验' },
