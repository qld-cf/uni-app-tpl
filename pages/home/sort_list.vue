<template>
	<view>
		...
		<view class="bg-white zaiui-swiper-box">
			<swiper class="screen-swiper square-dot c" autoplay circular indicator-dots :current="swiperIndex"
				@change="swiperChange">
		...
		<view class="bg-white zaiui-invest-title-box">
			...
			<view class="img"
				style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/home/sundry/16.png)" />
		</view>
				...
				<view class="cu-list grid col-2">
					...
					<view class="cu-item">
						...
						<view class="margin-top-sm zaiui-list-2-view">
							<view class="goods-img-view">
								<view class="cu-avatar xl radius"
									style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/5.png);" />
					...
					<view class="cu-item">
						...
						<view class="grid col-2 margin-top-sm">
							<view class="text-left goods-item">
								<view class="cu-avatar xl radius"
									style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/6.png);" />
							</view>
							<view class="text-left goods-item">
								<view class="cu-avatar xl radius"
					...
					<view class="cu-item">
						...
						<view class="grid col-2 margin-top-sm">
							...
							<view class="text-left goods-item">
								<view class="cu-avatar xl radius"
									style="background-image:url(https://ss1.ypshengxian.com/feassets/interview/pics/images/home/goods/9.png);" />
							</view>
						</view>
					</view>
				</view>
		...
		<view class="bg-white margin-top padding-bottom-sm padding-top-sm zaiui-goods-list-view-box">
			<scroll-view scroll-x class="nav z">
				<view class="flex text-center">
					<block v-for="(item,index) in goodsTab" :key="index">
						<view class="cu-item flex-sub text-black" :class="index==TabCur?'select':''" @tap="tabSelect"
							:data-id="index">
							<view>{{item}}</view>
			...
			<!--商品列表1-->
			<goods-sort-list :list_data="goodsSortListData" @listTap="goodsSortListTap" :show="TabCur==0?true:false">
			</goods-sort-list>
			<!--商品列表2-->
			<goods-sort-list :list_data="goodsSortListData" @listTap="goodsSortListTap" :show="TabCur==1?true:false">
			</goods-sort-list>
		</view>
