<template>
  <view>
    ...
    <bar-title bgColor="bg-white" isBack>
      <block slot="content">正式课列表</block>
    </bar-title>
    ...
    <view class="bg-white zaiui-news-list-box">
      <view class="margin-bottom cu-list menu-avatar">
        ...
        <view class="cu-item" :class="modalName=='move-box-'+ 0?'move-cur':''" @touchstart="ListTouchStart"
          @touchmove="ListTouchMove" @touchend="ListTouchEnd" :data-target="'move-box-' + 0" @tap="tapNews(0)">
          <view class="cu-avatar round" style="background-image:url(/static/images/home/swiper/1.png);">
            <view class="cu-tag badge" />
          </view>
          <view class="content">
            <view class="text-black">正式课</view>
            <view class="text-gray text-sm text-cut">正式课</view>
        ...
        <view class="cu-item goods" :class="modalName=='move-box-'+ 1?'move-cur':''" @touchstart="ListTouchStart"
          @touchmove="ListTouchMove" @touchend="ListTouchEnd" :data-target="'move-box-' + 1" @tap="tapNews(1)">
          <view class="cu-avatar round" style="background-image:url(/static/images/home/swiper/1.png);">
            <view class="cu-tag badge" />
          </view>
          <view class="content">
            <view class="text-black">
              <text class="margin-right-xs">正式课</text>
        ...
        <view class="cu-item goods" :class="modalName=='move-box-'+ 2?'move-cur':''" @touchstart="ListTouchStart"
          @touchmove="ListTouchMove" @touchend="ListTouchEnd" :data-target="'move-box-' + 2" @tap="tapNews(2)">
          <view class="cu-avatar round" style="background-image:url(/static/images/home/swiper/1.png);">
            <view class="cu-tag badge" />
          </view>
          <view class="content">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      tapNews(index) {
        uni.navigateTo({
          url: '/pages/class/normalClassDetail',
        });
      }
